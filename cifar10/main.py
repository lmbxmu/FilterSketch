...
def main():
    ...
    if args.arch == 'vgg':
        ...
        model = import_module(f'model.{args.arch}').resnet(args.cfg, num_classes=class_num).to(device)
    elif args.arch == 'googlenet':
        model = import_module(f'model.{args.arch}').GoogLeNet(num_classes=class_num).to(device)
    elif args.arch == 'densenet':
        model = import_module(f'model.{args.arch}').densenet_cifar(num_classes=class_num).to(device)
